...
<style>
.banner-area {
  background: url(c:\xamp\htdocs\for\project\img\header-bg.jpg) center;
				...
				<div class="container">
					...
					<div class="row fullscreen d-flex align-items-center justify-content-start">
						...
						<div class="banner-content col-lg-12 text-center">
							...
							<b><i><p style="color: red; text-shadow: 1px 1px 2px black, 0 0 45px green, 0 0 45px darkgreen;font-family: times, serif; font-size:75px;" class="text-white">
								Forensic And Crime Investigation Management System
							</p></i></b>
							<br/>
							<br/>
							<br/>
							<br/>
							<br/>
							<button type="button"  class="primary-btn text-uppercase float-right" data-toggle="modal" data-target="#myModal"> Experts Login </button>
							<br/>
							<br/>			
							<br/>
							<br/>

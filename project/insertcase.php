<?php
// Database connection
$mysqli = new mysqli("localhost", "root", "", "forensic");
...
// Query to view officers
$officer_query = "SELECT * FROM officer";
$run_officer = $mysqli->query($officer_query);
...
$run_lab = $mysqli->query($lab_query);
...
$lab_result = [];
if ($run_lab->num_rows > 0) {
    while ($row = $run_lab->fetch_assoc()) {
        $lab_result[] = $row;
    }
} else {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                    <?php
                    while($officer_r = $run_officer->fetch_assoc()) { ?>
                    <tr>
